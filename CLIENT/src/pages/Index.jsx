...
import { FaFileInvoiceDollar, FaMoneyBillWave, FaPiggyBank } from "react-icons/fa";
...
const Dashboard = () => {
    ...
    const applications = [
        {
            title: "Budget System",
            description: "Plan, allocate, and monitor budgets effectively across departments.",
            icon: <FaPiggyBank size={50} color="#4caf50" />,
            link: "https://budget.fmis.nia.gov.ph",
        },
        {
            title: "Disbursement Voucher System",
            description: "Streamline the process of creating and approving disbursement vouchers.",
            icon: <FaFileInvoiceDollar size={50} color="#2196f3" />,
            link: "https://dv.fmis.nia.gov.ph",
        },
        {
            title: "Cash System",
            description: "Manage cash inflows and outflows efficiently to maintain financial stability.",
            icon: <FaMoneyBillWave size={50} color="#fbc02d" />,
            link: "https://cash.fmis.nia.gov.ph",
        },
        {
            title: "Billing & Collection System",
            description: "Streamline billing and collection processes for efficient financial management.",
        ...
        <Box sx={{ p: 3, bgcolor: "#f5f5f5" }}>
            ...
            <Paper sx={{ p: 3, mb: 3, bgcolor: "#ffffff", borderRadius: 2, boxShadow: 3 }}>
                ...
                <Typography variant="body1" color="text.secondary">
                    You are logged in as <strong>{currentUser.Roles.length > 0 ? currentUser.Roles.join(',') : 'USER'}</strong> in <strong>FMIS</strong> at the {currentUser.Region} branch.
                </Typography>
            </Paper>

            {/* Report Section */}
            <Paper sx={{ p: 3, mb: 3, bgcolor: "secondary.main", color: "secondary.contrastText", borderRadius: 2, boxShadow: 3 }}>
                <Typography variant="h5" fontWeight="bold" gutterBottom>
                    Dashboard Overview
                </Typography>
                <Typography variant="body1">
                    These are all the systems under FMIS, each serving a specific function within the organization.
                </Typography>
            ...
            <Paper sx={{ p: 3, bgcolor: "#ffffff", borderRadius: 2, boxShadow: 3 }}>
                ...
                >
                    {applications.map((app, index) => (
                        <Box key={index} sx={{width: {xs: "100%", lg: '49%'}, bgcolor: "rgba(55, 94, 56, .8)", }}>
                        <Link
                            to={app.link}
                        ...
                        >
                            ...
                            >
                                {app.icon}
                                <Typography variant="h6" fontWeight="bold" color="primary.main" sx={{ mt: 2 }}>
                                    {app.title}
                                </Typography>
