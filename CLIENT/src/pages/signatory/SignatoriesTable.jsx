        ...
        <>
            ...
            <Box p={2}>
                ...
                <TableContainer component={Paper} sx={{ boxShadow: 3 }}>
                    <Table size="small">
                        <TableHead sx={{ bgcolor: 'secondary.main' }}>
                            <TableRow>
                                ...
                                <TableCell>
                                    <TableSortLabel
                                        active={orderBy === 'reportName'}
                                        direction={orderBy === 'reportName' ? order : 'asc'}
                                        onClick={() => handleRequestSort('reportName')}
                                    >
                                        Report Name
                                    </TableSortLabel>
                                </TableCell>
                                <TableCell>BOX A CERTIFIED</TableCell>
                                <TableCell>BOX C CERTIFIED</TableCell>
                                <TableCell>BOX D APPROVED FOR PAYMENT</TableCell>
                                    ...
                                    .map((signatory) => (
                                        ...
                                        >
                                            ...
                                            <TableCell
                                                ...
                                                title={signatory.reportName}
                                            >
                                                <TextSearchable columnName={signatory.reportName} />
                                            </TableCell>
                                            <TableCell>
                                                <Box
                                                    sx={{
                    ...
                    <TablePagination
                        component="div"
                        count={isEmpty ? 0 : data.pagination.totalCount}
                        page={page}
