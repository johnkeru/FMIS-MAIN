...
module.exports = {
  ...
  transactionType: "Infrastructure - Locally Funded Fund - Progress Payment",
      ...
      positionTypes: [
        {
          ...
          boxes: [
            ...
            },
            {
              ...
              findPosition:
                POSITIONS.DEPUTY_ADMINISTRATOR_CONCERNED.findPosition,
              displayPosition:
                POSITIONS.DEPUTY_ADMINISTRATOR_CONCERNED.displayPosition,
            },
          ],
        },
          ...
          boxes: [
            {
              ...
              findPosition:
                POSITIONS
                  .OFFICE_OF_THE_DEPUTY_ADMINISTRATOR_FOR_ENGINEERING_AND_OPERATIONS
                  .findPosition,
              displayPosition:
                POSITIONS
                  .OFFICE_OF_THE_DEPUTY_ADMINISTRATOR_FOR_ENGINEERING_AND_OPERATIONS
            ...
            },
            {
              name: "BOX C CERTIFIED",
              findPosition:
                POSITIONS.MANAGER_FINANCIAL_MANAGEMENT_DEPARTMENT.findPosition,
              displayPosition:
                POSITIONS.MANAGER_FINANCIAL_MANAGEMENT_DEPARTMENT
                  .displayPosition,
              department: "FINANCIAL MANAGEMENT DEPARTMENT",
