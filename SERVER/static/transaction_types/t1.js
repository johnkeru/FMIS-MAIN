...
module.exports = {
  ...
  transactionType:
    "Cash Advance - Payroll of Salaries, Wages, Allowances, Benefits, Honoraria and Other Similar Expenses (Over the Counter)",
          ...
          boxes: [
            {
              ...
              findPosition:
                POSITIONS.MANAGER_ADMINISTRATIVE_DEPARTMENT.findPosition,
              displayPosition:
                POSITIONS.MANAGER_ADMINISTRATIVE_DEPARTMENT.displayPosition,
            },
            {
